...
const style = {
  ...
  circle: css`
    ...
    dapa: `linear-gradient(180deg, rgb(0 139 170 / 15%) 0%, rgba(0,0,0,0) 100%)`
  })};
  `,
  midLight: css`
    position: absolute;
    ...
    background: ${theme.apply({ light: 'rgb(221 221 221 / 60%)', dark: 'rgb(107 107 107 / 50%)', dapa: `rgb(0 170 129 / 80%)` })};
  ...
  topLight: css`
    ...
    background: ${theme.apply({ light: 'rgb(213 213 213 / 40%)', dark: 'rgb(49 49 49 / 40%)', dapa: `rgb(0 170 150 / 40%)` })};
    filter: blur(12.7604166667vw);
  `,
  rightLight: css`
    position: absolute;
    ...
    height: 100%;
    background: ${theme.apply({ light: 'rgb(165 165 165 / 70%)', dark: 'rgb(22 22 22 / 70%)', dapa: `rgb(5 124 132 / 70%)` })};
